...
/**
 * Created by BeugFallou on 14/12/2014.
 */
public class GMailSender extends Authenticator {
    private String mailhost = "mail.gandi.net";
    private String user;
    ...
    public synchronized void sendMail(String subject, String body, String sender, String recipients) throws Exception {
        ...
        try{
            ...
            if (recipients.indexOf(',') > 0) {
               ...
               // message.setRecipients(Message, InternetAddress.parse(recipients));
            } else {
    ...
    public synchronized void sendSignalement(String subject, String body, String sender, String recipients,String file) throws Exception {
